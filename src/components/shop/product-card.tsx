...
export default function ProductCard({ product, isLoggedIn }: ProductCardProps) {
    ...
    return (
        <div className="group relative bg-white rounded-2xl p-5 mb-3 border border-slate-200 hover:border-blue-200 hover:shadow-md transition-all duration-200">
            <div className="flex items-center gap-3">
                ...
                {/* Product Info - flex-1 to take available space */}
                ...
                {/* Available Quantity - fixed width */}
                ...
                {/* Total Price - appears as additional column when in cart - fixed width */}
